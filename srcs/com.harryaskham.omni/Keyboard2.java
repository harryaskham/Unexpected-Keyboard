  ...
  implements SharedPreferences.OnSharedPreferenceChangeListener
{
  ...
  public void onFinishInputView(boolean finishingInput)
  {
    if (_config.keyboard_persistence_enabled) {
      ...
      android.util.Log.d("com.harryaskham.omni", "Keyboard persistence enabled - preventing hide on finish input view");
      _keyboardView.reset();
  ...
  public void onWindowHidden()
  {
    if (_config.keyboard_persistence_enabled) {
      ...
      android.util.Log.d("com.harryaskham.omni", "Keyboard persistence enabled - preventing hide on window hidden");
      requestShowSelf(0);
    } else {
  ...
  public class Receiver implements KeyEventHandler.IReceiver
  {
    ...
    {
      try {
        android.util.Log.d("com.harryaskham.omni", "Keyboard2: Sending system-wide key event: " + keyCode);
        sendDownUpKeyEvents(keyCode);
      } catch (Exception e) {
        android.util.Log.e("com.harryaskham.omni", "Keyboard2: Error sending system key event: " + e.getMessage());
      }
    }
  }
  ...
  {
    android.util.Log.d("com.harryaskham.omni", "Switching to floating IME");
    ...
    try {
      ...
      android.util.Log.d("com.harryaskham.omni", "Successfully switched to floating IME: " + floatingImeId);
    } catch (Exception e) {
      android.util.Log.e("com.harryaskham.omni", "Failed to switch to floating IME: " + e.getMessage());
