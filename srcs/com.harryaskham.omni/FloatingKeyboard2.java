...
import com.harryaskham.omni.prefs.LayoutsPreference;
  ...
  implements SharedPreferences.OnSharedPreferenceChangeListener
{
  ...
  public void onFinishInputView(boolean finishingInput)
  {
    ...
    if (!_config.keyboard_persistence_enabled) {
      android.util.Log.d("com.harryaskham.omni", "Hiding floating keyboard (persistence disabled)");
      removeFloatingKeyboard();
    } else {
      android.util.Log.d("com.harryaskham.omni", "Keeping floating keyboard visible (persistence enabled)");
    }
  }
  ...
  public void onFinishInput()
  {
    ...
    if (!_config.keyboard_persistence_enabled) {
      android.util.Log.d("com.harryaskham.omni", "Hiding floating keyboard on finish input (persistence disabled)");
      removeFloatingKeyboard();
    } else {
      android.util.Log.d("com.harryaskham.omni", "Keeping floating keyboard visible on finish input (persistence enabled)");
    }
  }
  ...
  public class Receiver implements KeyEventHandler.IReceiver
  {
    ...
    {
      try {
        android.util.Log.d("com.harryaskham.omni", "FloatingKeyboard2: Sending system-wide key event: " + keyCode);
        sendDownUpKeyEvents(keyCode);
      } catch (Exception e) {
        android.util.Log.e("com.harryaskham.omni", "FloatingKeyboard2: Error sending system key event: " + e.getMessage());
      }
    }
  ...
  {
    android.util.Log.d("com.harryaskham.omni", "Switching to docked IME");
    ...
    try {
      ...
      android.util.Log.d("com.harryaskham.omni", "Successfully switched to docked IME: " + dockedImeId);
    } catch (Exception e) {
      android.util.Log.e("com.harryaskham.omni", "Failed to switch to docked IME: " + e.getMessage());
      ...
      try {
        ...
        android.util.Log.d("com.harryaskham.omni", "Fallback switch successful");
      } catch (Exception e2) {
        android.util.Log.e("com.harryaskham.omni", "Fallback failed, showing IME picker: " + e2.getMessage());
  ...
  private void toggle_keyboard_persistence()
  {
    ...
    android.util.Log.d("com.harryaskham.omni", "Toggling keyboard persistence from " + currentState + " to " + newState);
